...
An important distinction throughout:

> **Imperative languages** tell the computer *how* to do something, step by step.
>
> **Declarative languages** specify *what* result you want, letting the system figure out how to achieve it.

SQL is declarative—you describe the pattern of data you want, and the query optimizer decides the best execution strategy. This separation enables the database to improve performance without changing application code.

Declarative languages also parallelize more easily since they don't specify a particular order of operations.
