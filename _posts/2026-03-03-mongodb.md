...
## Q1.2 - Why does MongoDB use BSON instead of plain JSON? <span class="badge-difficulty badge-must-know">must-know</span>
...
## Q1.3 - What does the `_id` field do, and what happens if you don't provide one? <span class="badge-difficulty badge-must-know">must-know</span>
